            ...
            DO jk = 1, nksr + 1
               DO jj = 2, jpjm1                       ! Separation in R-G-B depending of the surface Chl
                  DO ji = fs_2, fs_jpim1
                     ...
                     ! Commenting out this bit of code as I want to load in chlorophyll concentrations
                     ! with the same units as rn_chl_conc
                     ...
                     zchl3d(ji,jj,jk) = MIN( 50. , MAX( 0.01, sf_chl(1)%fnow(ji,jj,1) ) )
                  END DO
                  !
               END DO
            END DO
